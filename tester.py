...
#     for train_idx, test_idx in cv:
    ...
    # Format get clf name for return dict clf_scores_dict
    clf_scores_dict = {}
    clf_name_str = str(clf.steps[1][1]).split('(')[0]
    clf_name__params = clf_name_str + '_params'
    clf_scores_dict = {'classifier': clf_name_str, 'classifier_params': str(clf.steps[1][1]), 
                       'accuracy': accuracy, 'precision': precision, 'recall': recall, 'f1': f1, 'f2': f2,
                       'total_predictions': total_predictions, 'true_positives': true_positives, 'false_positives':false_positives,
